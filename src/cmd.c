...
struct ext_func_tab extcmdlist[] = {
    ...
    { 0, "loadstate", "load previous state",
              doloadstate, AUTOCOMPLETE | GENERALCMD | NOFUZZERCMD, NULL },
    ...
    { 0, "savestate", "save current state",
              dosavestate, AUTOCOMPLETE | GENERALCMD | NOFUZZERCMD, NULL },
